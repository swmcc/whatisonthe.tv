...
- **Web Dyno**: Runs FastAPI backend with Uvicorn
...
The frontend (SvelteKit) should be deployed separately to a static hosting service:

- **Vercel** (recommended for SvelteKit)
- **Netlify**
- **Cloudflare Pages**

Configure the frontend's API URL to point to your Heroku backend:
```javascript
// frontend/.env.production
PUBLIC_API_URL=https://whatisonthe-tv.herokuapp.com
```
